...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-organizations-organizations-module"], {
  ...
  function srcAppPagesOrganizationsOrganizationsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var OrganizationsPage = /*#__PURE__*/function () {
      function OrganizationsPage(apiAuth, apiCommon) {
        var _this = this;
                  ...
                  case 6:
                    ...
                    if (Array.isArray(this.organizations)) {
                      ...
                      this.organizations.forEach(function (el) {
                        ...
                        el.click_type = 2; //xóa các quan hệ cấp trên

                        if (el.id === el.root_id) el.parent_id = undefined; //mở cây trước đó

                        if (_this2.itemOpen && (_this2.itemOpen.parent_id === el.id || _this2.itemOpen.id === el.id)) {
                          el.visible = true;
                        }
                      }); // tạo cấu trúc hình cây để khai báo, chỉnh sửa cây tổ chức

                      organizationsTree = this.apiCommon.createTreeMenu(this.organizations, 'id', 'parent_id');

                      if (this.userReport && Array.isArray(organizationsTree)) {
                        this.organizationsTree = organizationsTree.filter(function (x) {
                          return x.id === _this2.userReport.organization_id;
                        });
                      } else {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_2__["CommonsService"]])], OrganizationsPage);
    /***/
  }
}]);
