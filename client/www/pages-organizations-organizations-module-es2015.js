...
let OrganizationsPage = class OrganizationsPage {
    constructor(apiAuth, apiCommon, apiDownload, apiExcel) {
        ...
        this.callbackDownload = function (ws, config) {
            return new Promise((resolve) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                try {
                    let result = yield this.apiExcel.processWriteExcel(this.organizationsTree, ws, config);
...
let ApiDownloadService = class ApiDownloadService {
    ...
    processFileDownload(urlTemplateFile, sheet_name, file_name, config, callbackPromise, delayMilis) {
                ...
                wb.xlsx.load(bufferData)
                    ...
                    workbook.eachSheet((sheet) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                        if (sheet.name === sheet_name) {
                            try {
                                let ws = sheet;
                                let resultCallback = yield callbackPromise(ws, config);
                    ...
                    yield this.apiCommon.delay(delayMilis || 5000, arrayOutput);
...
ApiDownloadService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
ApiExcelService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
