...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-staffs-staffs-module"], {
  ...
  function srcAppPagesStaffsStaffsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    StaffsPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppPagesStaffsStaffsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    StaffsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppPagesStaffsStaffsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StaffsPage = /*#__PURE__*/function () {
      function StaffsPage(apiAuth, apiCommon, socket) {
        ...
        this.callbackProcess = function (res) {
          ...
          return new Promise(function (resolve) {
            if (res.error) {
              ...
              _this.socket.emit('client-staff-done');
            }
      ...
      _createClass(StaffsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.refreshNews();
          this.socket.on("server-staff-done", function () {
                  ...
                  case 5:
                    ...
                    if (Array.isArray(this.staffs)) {
                      ...
                      this.orgTree.forEach(function (el) {
                        ...
                        if (_this3.staffs && el.id !== _this3.organizationId) {
                          // ghép nhân sự vào theo id tổ chức
                          el.subs = _this3.staffs.filter(function (x) {
                      ...
                      this.organizationsTree.forEach(function (el) {
                        ...
                        if (_this3.staffs && el.id + '' === '' + _this3.organizationId) {
                          var rootSubs = _this3.staffs.filter(function (x) {
                            return x.organization_id === el.id;
    ...
    StaffsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-staffs',
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_2__["CommonsService"], ngx_socket_io__WEBPACK_IMPORTED_MODULE_5__["Socket"]])], StaffsPage);
    /***/
  }
}]);
